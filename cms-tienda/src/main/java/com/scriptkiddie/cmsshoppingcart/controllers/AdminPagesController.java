...
import com.scriptkiddie.cmsshoppingcart.models.PageRepository;
...
public class AdminPagesController {
    ...
    public String add(@Valid Page page, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        redirectAttributes.addFlashAttribute("message", "¡Página agregada!");
        ...
        if ( slugExists != null ) {
            redirectAttributes.addFlashAttribute("message", "¡Esta dirección ya existe!");
    ...
    public String edit(@Valid Page page, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        redirectAttributes.addFlashAttribute("message", "¡Página editada!");
        redirectAttributes.addFlashAttribute("alertClass", "alert-success");
    ...
    public String edit(@PathVariable int id, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("message", "¡Página eliminada!");
        redirectAttributes.addFlashAttribute("alertClass", "alert-success");
